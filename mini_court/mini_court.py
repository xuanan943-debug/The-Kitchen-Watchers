...
class MiniCourt():
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self,player_boxes, ball_boxes, original_court_key_points ):
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            # AN TOÀN: Kiểm tra xem có bóng trong frame này không
            ball_box = None
            ...
            output_ball_bboxes_dict = {} # Lưu tạm bóng của frame này
            ...
            for player_id, bbox in player_bbox.items():
                ...
                # Get Player height in pixels (AN TOÀN: Bỏ qua các frame người bị khuất)
                ...
                if len(bboxes_heights_in_pixels) > 0:
                    ...
                    max_player_height_in_pixels = get_height_of_bbox(bbox) # Lấy tạm chiều cao frame hiện tại

                # AN TOÀN: Cho chiều cao mặc định là 1.8m nếu là người chơi thứ 3, thứ 4...
                player_height_m = player_heights.get(player_id, 1.8)
                ...
                # Nếu đây là người đánh bóng và máy có nhận diện được bóng
                if closest_player_id_to_ball == player_id and ball_position is not None:
                    ...
                    output_ball_bboxes_dict[1] = mini_court_ball_position
